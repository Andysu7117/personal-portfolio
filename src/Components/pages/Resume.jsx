        ...
        <section id="resume" className="text-gray-400 bg-gray-900 body-font">
            <div className="container px-5 py-10 mx-auto text-center lg:px-40">
                ...
                <div className="flex flex-col w-full mb-20">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">LinkedIn: <a href="www.linkedin.com/in/andysu7117" className="underline text-gray-400 hover:text-white">www.linkedin.com/in/andysu7117</a></p>
